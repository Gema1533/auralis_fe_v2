...
const HeroSection = () => {
  return (
    <section className="h-screen min-h-[50vh] w-full relative flex items-center justify-center text-center overflow-hidden">
      ...
      >
        <source
          src="https://assets.mixkit.co/videos/preview/mixkit-luxury-perfume-in-a-black-background-4443-large.mp4"
          type="video/mp4"
        />
        Browser Anda tidak mendukung tag video.
      </video> */}
      <img
        src="./img/bg/bg-hero.jpg"
        className="absolute z-0 w-auto min-w-full min-h-full max-w-none"
        alt=""
      />
      <div className="relative z-20 container mx-auto px-6">
        ...
        >
          Temukan aroma yang melampaui waktu, sebuah tanda tangan tak terlihat
          dari esensi diri Anda.
        </motion.p>
        <motion.a
